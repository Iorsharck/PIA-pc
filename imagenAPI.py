...
logging.basicConfig(filename='imagenAPIPY.log',level=logging.INFO,format='%(asctime)s %(message)s', datefmt='%m/%d/%Y %I:%M:%S %p')
...
parser.add_argument("-k","--key", metavar='API KEY', help="Key of the Pexels API", default="K8yaOzBLBeEhJ830855QhUkK5HIxR61tJt3vxHnA2xOfXDmqxsnj5BbS", type=str)
parser.add_argument("-p","--prompt", help="Prompt de la imagen", default="random", type=str)
parser.add_argument("-n","--num", metavar='NUMERO DE IMAGENES', help="Numero de imagenes", default="1", type=int)
